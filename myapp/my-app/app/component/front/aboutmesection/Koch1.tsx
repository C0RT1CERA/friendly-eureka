...
const iterations = 3;
const size = 300;
const spacing = size * 0.8; // Adjust spacing between snowflakes
...
export function Koch1() {
  return (
    <div className="flex items-center justify-center w-full h-screen bg-gray-900">
      <svg viewBox={`0 0 ${size * 2} ${size}`} className="w-[1000px] h-[5000px]">
        {/* Left Snowflake - Rotates Clockwise */}
        <motion.g
          animate={{ rotate: 360 }}
        ...
        {/* Right Snowflake - Rotates Counterclockwise */}
        <motion.g
          animate={{ rotate: -360 }}
          transition={{ duration: 6, ease: "linear", repeat: Infinity }}
          transform={`translate(${size / 2 + spacing}, ${size / 2})`}
        >
