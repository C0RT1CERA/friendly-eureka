...
export function KochScroll() {
  ...
  // Smoothly map scroll speed to rotation angle
  ...
  return (
    <div className="flex items-center justify-center w-full h-[300vh] bg-gray-900">
      <svg viewBox={`0 0 ${size} ${size}`} className="w-[350px] h-[350px] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <motion.g
          style={{ rotate: rotate }}
        >
