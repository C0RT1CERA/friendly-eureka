...
export function KochScroll1() {
  const containerRef = useRef(null);
  const { scrollYProgress } = useScroll({
    container: containerRef, // Track scrolling inside this div
  });

  // Map scroll progress (0 to 1) → rotation (0° to 360°)
    ...
    <div ref={containerRef} className="relative w-full h-screen overflow-y-scroll bg-gray-900">
      ...
      <div className="h-[300vh] flex justify-center items-center">
        <svg
          ...
          className="w-[350px] h-[350px] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
        >
          <motion.g style={{ rotate: smoothRotate }}>
